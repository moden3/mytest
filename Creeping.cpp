...
//walk_times：繰り返し回数。この回数をnとすると、2n + step_lengthだけ進むはず(実際には全然進まない)
{
    ...
    for (int i(1); i <= walk_times; i++)
    {
        ...
        Output_Coordinate(x0, -y1, rf.adjust + step_height,
                          ...
                          x0, y0 * ratio_left, lf.adjust,
                          all_height,
                          creeping_step_times, creeping_wait_time*2); //(3)-1
        ...
        Output_Coordinate(x0, -y1 + step_length * ratio_right, rf.adjust,
                          ...
                          x0, y0 * ratio_left, lf.adjust,
                          all_height,
                          creeping_step_times * 4, creeping_wait_time*2); //(4)
        ...
        Output_Coordinate(x0, y0 * ratio_right, rf.adjust,
                          ...
                          x0, -y1, lf.adjust,
                          all_height,
                          creeping_step_times, creeping_wait_time*2); //(6)-1
        ...
        Output_Coordinate(x0, y0 * ratio_right, rf.adjust,
                          ...
                          x0, -y1, lf.adjust,
                          all_height,
                          creeping_step_times * 4, creeping_wait_time*2); //(7)
        ...
        Output_Coordinate(x0, y0 * ratio_right, rf.adjust,
                          ...
                          all_height,
                          creeping_step_times, creeping_wait_time*2); //(8)-1
        ...
        Output_Coordinate(x0, y0 * ratio_right, rf.adjust,
                          ...
                          all_height,
                          creeping_step_times * 4, creeping_wait_time*2); //(9)
        ...
        Output_Coordinate(x0, -y1, rf.adjust,
                          ...
                          x0, y0 * ratio_left, lf.adjust,
                          all_height,
                          creeping_step_times, creeping_wait_time*2); //(11)-1
    ...
    Output_Coordinate(x0, -y1, rf.adjust,
                      ...
                      x0, y0, lf.adjust,
                      all_height,
                      creeping_step_times * 4, creeping_wait_time*2); //(2)
