...
double leglength[3] = { 10,143.01*1.6,297.95/1.4 };		// 脚の長さ[mm]、{角柱の一辺の長さ,脚の上下の関節から膝の関節までの長さ、膝の関節から足先までの長さ}
...
double slopepos[3] = { 0,1700,0 };				// スロープの位置
double slopecolor[3] = { 1.0,0.85,0.7 };		// スロープの色

double sandpos[3] = { 0,850,0 };				// サンドの位置
